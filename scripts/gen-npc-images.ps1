...
$images = @(
  @{
    ...
    Prompt = "Dark cinematic 3D render on a near-black background, premium tech-editorial style. A single sleek translucent glass scoring gauge, a smooth semicircular dial, glowing with thin neon emerald-green edges, centered with generous negative space. Beneath it, three horizontal glowing bars of clearly different lengths suggesting a weighted breakdown, the same emerald glow. Off to one side, one small glowing rounded badge in warm red floats apart from the gauge, like a flag set beside a number. Soft emerald and teal volumetric fog hugging the floor with a faint mirror reflection, gentle light haze, small floating dust particles, subtle lens bloom. No text, no letters, no numbers, no people, no logos. Minimalist, lots of negative space, dark moody lighting, 16:9 cinematic composition."
  },
  @{
  ...
  @{
    ...
    Prompt = "Dark cinematic 3D render on a near-black background, premium tech-editorial style. A single floating translucent glass panel with thin neon blue edges, showing a grid of small glowing blue check marks, centered in frame. One corner of the panel is cracking and breaking apart into glowing warm-red shards, with a small red warning triangle glyph emerging from the crack. The contrast between the calm blue panel of checks and the breaking red corner is the focus. Soft blue volumetric fog hugging the floor with a faint mirror reflection, gentle light haze, small floating dust particles, subtle lens bloom. No text, no letters, no numbers, no people, no logos. Minimalist, lots of negative space, dark moody lighting, 16:9 cinematic composition."
  },
  @{
    Out = "public/npc-coach-dashboard.png"
    Prompt = "Dark cinematic 3D render on a near-black background, premium tech-editorial style. A single floating translucent glass dashboard panel, slightly angled, glowing with thin neon amber-gold edges, centered with generous negative space. On the panel, a few abstract list rows with small glowing score bars of different lengths, and along the top a row of five connected glowing dots forming a progress stepper, one of them brighter than the rest. Soft amber and gold volumetric fog hugging the floor with a faint mirror reflection, gentle light haze, small floating dust particles, subtle lens bloom. No text, no letters, no numbers, no people, no logos. Minimalist, lots of negative space, dark moody lighting, 16:9 cinematic composition."
  }
)
