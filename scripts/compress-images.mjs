...
const RULES = [
  ...
  { match: /^(cbct-validator|treatment-estimator|cowork-dashboard|doc-coach|npc-coach|loan-radar|llm-persuasion|enterprise-data|accounting-automation|pipeline-ghosting|film-and-engineering|optimal-living-systems|fake-news|resnet-compact|customer-segmentation|buffer_overflow|heap_exploit|comics|paper|simpsons|jobpilot|jobpilot-judge|doctor-report-cards)\.png$/i, width: 1600, quality: 78 },
