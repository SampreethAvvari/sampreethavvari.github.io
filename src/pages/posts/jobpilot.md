...
- senior / staff / principal / 5+ years / contract / part-time → gone (I'm early-career; 0–2 years only)
...
Two guardrails I refuse to ship without. First, **truth**: the model may reorder, rephrase, and re-emphasize — it may never invent an employer, a date, a metric, or a skill. Second, **format**: if the PDF spills past one page, it gets recut automatically, and an ATS check gates every resume at ≥ 85% keyword coverage.
...
- **Pipeline:** Python 3.12, httpx, pydantic — Cloud Run job
...
| Apify LinkedIn scraper | $0–5/mo (free credits) |
| **Total** | **< $5/month** |
...
|---|---|---|
| Job freshness | days–weeks old, reposts | hours old, straight from ATS boards |
